                ...
                c => new
                    {
                        ...
                        TotalSalario = c.Double(nullable: false),
                        IdEmpleado = c.Int(nullable: false),
                    })
                ...
                c => new
                    {
                        ...
                        cantidad = c.Int(nullable: false),
                        IdTerminoCarne = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.IdDetalle)
                .ForeignKey("dbo.Menus", t => t.IdMenu, cascadeDelete: true)
                .ForeignKey("dbo.Pedidoes", t => t.IdPedido, cascadeDelete: true)
                .ForeignKey("dbo.TerminosCarnes", t => t.IdTerminoCarne, cascadeDelete: true)
                .Index(t => t.IdMenu)
                .Index(t => t.IdPedido)
                .Index(t => t.IdTerminoCarne);
